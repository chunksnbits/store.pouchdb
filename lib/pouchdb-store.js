...
// ------------------------------------------------------------ Object creation
// ------------------------------------------------------- Constructor
function PouchDbStore (pouch, schema) {
...
// ------------------------------------------------------- Static loader
PouchDbStore.load = function (pouch, schema) {
  return new PouchDbStore(pouch, schema);
};
 ...
 *             - properties: The properties of this store. Will be used
...
/**
 * @description
 *   Adds a new property schema definition to this store.
 *   This property will be part of the this store's schema validation.
 *
 * @params:
 ...
 */
PouchDbStore.prototype.property = function (name, schema) {
...
PouchDbStore.prototype.store = function (items) {
  ...
  return this._adapter.store(items)
    .then(function (storedItems) {
      storedItems = self._convertToItem(storedItems);
 ...
 * @description
 *  Lookup method for this store.
 *  Will return all items currently stored in this store.
 *
 *  Methods supported:
 *   @returns
 ...
 *
 */
PouchDbStore.prototype.all = function () {
  var self = this;
...
/**
 * @description
 *  Clearance method for this store.
 *  Will remove all items currently stored in this store.
 *
 * @returns:
 *  [Promise]: A promise that will be resolved on the operation has been
 *             processed.
 *
 */
PouchDbStore.prototype.empty = function () {
...
// ------------------------------------------------------------ Language functions
// ------------------------------------------------------- toString
PouchDbStore.prototype.validate = function (items) {
