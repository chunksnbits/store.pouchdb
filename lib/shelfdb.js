...
try {
  console.info('Attempting to load shelfdb-minimongo... ');
  Adapter = require('shelfdb-minimongo')(ExceptionHandler);
...
try {
  console.info('Attempting to load shelfdb-pouch... ');
  Adapter = require('shelfdb-pouch')(ExceptionHandler);
  console.info(' ... success');
} catch (e) {
  console.info(' ...failed');
}
...
ShelfDb.ExceptionHandler = require('./exception-handler.js');
